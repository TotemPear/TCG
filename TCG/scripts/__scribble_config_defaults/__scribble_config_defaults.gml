...
#macro SCRIBBLE_DEFAULT_WAVE_FREQUENCY      100      //Default wave frequency. Larger values create more "humps" over a certain number of characters
#macro SCRIBBLE_DEFAULT_WAVE_SPEED          0.1      //Default wave speed. Larger numbers cause characters to move up and down more rapidly
